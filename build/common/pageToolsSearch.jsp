<!-- pageToolsSearch.jsp -->
        ...
        <div id="tools">
            ...
            <% if (LoginMgr.isDeveloper(request)) {
             ...
             %>
            <div class="tool_label"><a href="<%= AntwebProps.getDomainApp() %>/mapResults.do">Map Results (Dev)</a></div>            
            <% } %>
    ...
    <div class="tools" id="compare_tools" style="display:none;">
        ...
        <div class="tool_text">
            Select <%=taxon.getNextRank().toLowerCase()%> and click "Compare Selected". <input id="compare_form" class="submit" type="button" value="Compare Selected"> <a href="#" onclick="hideTools('compare_tools'); return false;">Cancel</a>
        </div>
        <div class="clear"></div>
    </div>
    <div class="tools" id="map_tools" style="display:none;">
        ...
        <div class="tool_text">
            Select <%=taxon.getNextRank().toLowerCase()%> and click "Map Selected". <input id="map_form" class="submit" type="button" value="Map Selected"> <a href="#" onclick="hideTools('map_tools'); return false;">Cancel</a>
        </div>
        <div class="clear"></div>
    </div>
    <div class="tools" id="fieldguide_tools" style="display:none;">
        ...
        <div class="tool_text">
            Select <%=taxon.getNextRank().toLowerCase()%> and click "Create Field Guide". <input id="fieldguide_form" class="submit" type="button" value="Create Field Guide"> <a href="#" onclick="hideTools('fieldguide_tools'); return false;">Cancel</a>
        </div>
        <div class="clear"></div>
    </div>
