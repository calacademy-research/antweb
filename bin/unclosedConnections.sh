...
grep "Overdue resource check-out stack trace" ../links/antwebInfo.log -B 1 -A 5 | grep "overdue\|BrowseAction\|TaxaPageAction" > /data/antweb/log/unclosedConnections/$today
