...
public class UtilDataAction extends Action {
        ...
        if (message == null) {
            try {
                ...
                if (action != null) {
                    ...
                    s_log.debug("execute() action:" + action + " operationDetails:" + operationDetails + " forward:" + forward);
    ...
    private String handleException(Exception e, Connection connection, String action, String loginName) {
        s_log.error("handleException() Rollback data for action:" + action + " user:" + loginName + " e:" + e);
        try {
