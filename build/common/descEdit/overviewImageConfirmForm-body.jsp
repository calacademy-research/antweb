...
<br>
<H2>Overview Image Upload Confirm Page</H2>
<br>
<%
...
// String newEditAction = Utility.stripParams(thisPageTarget, "editField");
   AntwebUtil.log("info", " editField:" + descForm.getEditField() ); 

  String newEditAction = descForm.getTarget();
  newEditAction = HttpUtil.trimDomainApp(newEditAction);
  AntwebUtil.log("info", "overviewImageConfirm-body.jsp newEditAction:" + newEditAction); 
%>
...
<input type="hidden" name="rank" value="<%= descForm.getRank() %>">
