    ...
    public ActionForward execute(
        ...
        try {
          ...
          if (action.equals("countries")) {
            ...
            request.setAttribute("message", message);
            return (mapping.findForward("message"));            
          } else if (action.equals("recentDescEdits")) {
          ...
          } else if (action.equals("getTaxonNames")) {				    
