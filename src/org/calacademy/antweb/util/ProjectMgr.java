...
//          }
    ...
    public static boolean hasMoved(HttpServletRequest request, HttpServletResponse response) {
...
*/
            ...
            if (target.contains("malagasyants"))
                redirect = target.replace("project=malagasyants", "bioregionName=Malagasy");
            if (target.contains("eurasianants"))
                redirect = target.replace("project=eurasianants", "Palearctic"); //"/bioregion.do?name=Palearctic";
            if (target.contains("nearcticants"))
                redirect = target.replace("project=nearcticants", "Nearctic"); //"/bioregion.do?name=Nearctic";
            if (target.contains("pacificislandsants"))
                redirect = target.replace("project=pacificislandsants", "Oceania"); //"/bioregion.do?name=Oceania";
            if (target.contains("africanants"))
                redirect = target.replace("project=africanants", "Afrotropical"); //"/bioregion.do?name=Afrotropical";
            if (target.contains("neotropicalants"))
                redirect = target.replace("project=neotropicalants", "Neotropical"); //"/bioregion.do?name=Neotropical";
            if (target.contains("australianants"))
                redirect = target.replace("project=australianants", "Australasia"); //"/bioregion.do?name=Australasia";
            if (target.contains("southeastasiaants"))
                redirect = target.replace("project=southeastasiaants", "Indomalaya"); //"/bioregion.do?name=Indomalaya";
            ...
            if (target.contains("calants") && !target.contains("eotropicalants") && !target.contains("frotropicalants"))
                redirect = target.replace("calants", "californiaants");
            ...
            if (target.contains("solomonislandants"))
                redirect = target.replace("solomonislandants", "solomonislandsants");
                ...
                if (target.contains("project=") && target.contains("ants")) {
                    ...
                    if (country != null) {
                      //s_log.warn("hasMoved() newTarget:" + newTarget);
                        ...
                        redirect = target.substring(0, projectI - 8) + "countryName=" + country.getName() + target.substring(antsI + 4);
                    }
