...
grep "Overdue resource check-out stack trace" /antweb/links/antwebInfo.log -B 1 -A 5 | grep "BrowseAction\|overdue" > /data/antweb/web/log/unclosedConnections/$today
