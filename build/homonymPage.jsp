...
<%
  ...
  //if (AntwebProps.isDevMode()) AntwebUtil.log("homonymPage.jsp rank:" + taxon.getRank()); 
  ...
  metaString+= "<meta name='description' content='Overview of " + taxon.getRank() +  " " + taxon.getPrettyName() + " from AntWeb.'/>";
%>
...
<tiles:insert beanName="antweb.default" beanScope="request" flush="true">
	...
	<tiles:put name="body-content" value="/homonymPage-body.jsp" />	
</tiles:insert>
