...
<p>In print, each image must include attribution to its photographer, the specimen code of the image, and "from <a href="http://www.antweb.org/">www.antweb.org</a>" in each figure caption. 
...
<p><pre>AntWeb.  Available from http://www.antweb.org. Accessed <span class="today"></span></pre></p> 

<b>To cite individual sections (example):</b>

<p><pre>Ward, P. S., editor (2013). AntWeb: Ants of California. Available from: http://www.antweb.org/california.jsp. Accessed <span class="today"></span></pre></p> 
