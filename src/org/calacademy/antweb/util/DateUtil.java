...
//    return formatDate;
    ...
    public static String testConstructDateStr(String dateStr) {
        ...
        if (constructedDate == null)
            A.log("testConstructDateStr() dateStr:" + dateStr + " formatted:" + constructedDate + " step:" + s_debugStep);
...
*/
    ...
    // Basically just for validation. Have a dateStr in our preferred format and want a date object.
