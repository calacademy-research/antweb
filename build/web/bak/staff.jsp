...
<%@ page import="org.calacademy.antweb.Group" %><%@ page import="org.calacademy.antweb.Utility" %><% String domainApp = (new Utility()).getDomainApp(); %>
...
%>	   	   
<form method="POST" action="<%= domainApp %>/ancPageEdit.do?id=9" />	   		
